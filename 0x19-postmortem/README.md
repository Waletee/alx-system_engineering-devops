...
error in `wp-settings.php` when tyring to load the file `class-wp-locale.phpp`. The correct file name, located in the `wp-content` directory of the application folder, was `class-wp-locale.php`.
...
* Test! Test!! Test!!!. Test the application before deploying. This error would have occurred
...
[0-strace_is_your_friend.pp](https://github.com/Waletee/alx-system_engineering-devops/blob/master/0x17-web_stack_debugging_3/0-strace_is_your_friend.pp)
